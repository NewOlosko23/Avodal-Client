        ...
        >
          ...
          <div className="relative max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
              Powering Your Digital World, Securing Your Space. We are dedicated
              to delivering reliable technology solutions that empower
              businesses, institutions, and individuals to thrive in today’s
              digital era.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                powering communities, businesses, and organizations with tools
                that drive growth, connectivity, and security.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-16 px-6 md:px-12">
          <div className="max-w-6xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
              ...
              services designed to simplify your digital journey while securing
              your operations.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="p-6 bg-gray-50 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="text-lg font-semibold mb-2">CCTV & Security</h3>
              <p className="text-sm text-gray-600">
                Reliable surveillance and monitoring solutions to protect your
                assets and ensure peace of mind.
              </p>
            </div>
            <div className="p-6 bg-gray-50 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-600">
                From small offices to large enterprises, we design and implement
            ...
            <div className="p-6 bg-gray-50 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-600">
                Custom websites, apps, and SEO strategies to build your online
            ...
            <div className="p-6 bg-gray-50 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-600">
                Sales, repair, and software development services that keep your
        ...
        <section className="py-16 px-6 md:px-12 bg-gray-100">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-12 max-w-3xl mx-auto">
              We go beyond providing IT solutions — we create partnerships built
              on trust, quality, and long-term growth.
            </p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
              <div className="p-6 bg-white rounded-2xl shadow hover:shadow-md transition">
                ...
                <p className="text-sm text-gray-600">
                  We leverage modern technologies to create solutions that meet
              ...
              <div className="p-6 bg-white rounded-2xl shadow hover:shadow-md transition">
                ...
                <p className="text-sm text-gray-600">
                  We are rooted in Kenya and dedicated to empowering communities
