      ...
      <>
        <>
          ...
          <Helmet>
            {/* Title & Description */}
            <title>
              Avodal Technology | IT Solutions, Networking & Security
            </title>
            <meta
              name="description"
              content="Avodal Technology delivers end-to-end IT solutions — from networking and CCTV installations to websites and custom software. Secure, modern, and reliable technology for businesses."
            />
            <meta
              name="keywords"
              content="Avodal Technology, IT solutions Kenya, CCTV installation, networking, website development, software solutions, tech support"
            />
            <link rel="canonical" href="https://www.avodaltech.com/" />

            {/* Open Graph / Facebook */}
            <meta
              property="og:title"
              content="Avodal Technology | IT & Security Solutions"
            />
            <meta
              property="og:description"
              content="Powering your digital world and securing your space with expert IT, networking, CCTV, and software solutions."
            />
            <meta
              property="og:image"
              content="https://www.avodaltech.com/assets/1.svg"
            />
            <meta property="og:url" content="https://www.avodaltech.com/" />
            ...
            <meta
              ...
              content="Secure and modern IT solutions — Networking, CCTV, Websites & Software Development."
            />
            <meta
              name="twitter:image"
              content="https://www.avodaltech.com/assets/1.svg"
        ...
        <>
            ...
            <div className="max-w-7xl mx-auto px-6 py-20 lg:py-32 grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="mt-6 text-lg text-indigo-100">
                  ...
                  empower businesses with secure, reliable, and modern
                  technology.
                </p>
          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                <h2 className="text-4xl font-bold text-indigo-700">40+</h2>
          ...
          <section className="py-20 bg-gray-100">
            <div className="max-w-4xl mx-auto text-center px-6">
              ...
              <p className="text-gray-600 mb-8">
                Partner with Avodal Technology today and experience secure,
                modern IT solutions built for growth.
              </p>
              <Link
                to="/contact-us"
